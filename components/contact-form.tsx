              ...
              <div className="space-y-2">
                ...
                <Select required name="budget">
                  ...
                  <SelectContent className="bg-white cursor-pointer">
                    <SelectItem value="under-5k" className="cursor-pointer">
                      Under ₹5,000
                    </SelectItem>
                    <SelectItem value="5k-10k" className="cursor-pointer">
                      ₹5,000 - ₹10,000
                    </SelectItem>
                    <SelectItem value="10k-25k" className="cursor-pointer">
                      ₹10,000 - ₹25,000
                    </SelectItem>
                    <SelectItem value="25k-50k" className="cursor-pointer">
                      ₹25,000 - ₹50,000
                    </SelectItem>
                    <SelectItem value="50k-100k" className="cursor-pointer">
                      ₹50,000 - ₹100,000
                    </SelectItem>
                    <SelectItem value="over-100k" className="cursor-pointer">
                      Over ₹100,000
                    </SelectItem>
                  </SelectContent>
                </Select>
