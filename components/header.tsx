        ...
        <div className="flex items-center justify-between py-3 px-6 md:px-8 rounded-2xl liquid-glass transition-all duration-300 ">
          ...
          <nav className="hidden md:flex items-center gap-8 font-mono text-xs uppercase tracking-wider">
            ...
            <Link
              ...
              className="group flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg border border-borderGlass bg-surface text-textMain hover:bg-green hover:text-black hover:border-green transition-all shadow-xs text-xs font-semibold"
            >
              <span>Resume</span>
