  ...
  return (
    <div className="relative h-[100vh] xl:h-[500px] text-white  px-8 xl:mb-16 xl:px-64 pt-32 bg-primary">
      <div className="  relative">
        ...
        <p className="subheading-one py-8  uppercase max-w-lg xl:float-right tracking-wide text-sm">
          Nazrul Islam is a passionate software developer with a knack for
          turning lines of code into digital wonders.
        </p>
      </div>
      <p className="about h-full xl:max-w-7xl xl:text-6xl text-xs  leading-normal xl:pb-32">
        ...
        background and a talent for inventive problem-solving, Nazrul Islam is
