...
function Years() {
  return (
    <div className="bg-primary py-12 text-white selection:bg-primary h-full selection:text-secondary px-6 md:px-12 xl:px-16 2xl:px-24">
      <motion.p
      ...
      >
        ...
        at <strong className="text-secondary">HCLTech</strong>. In this role, he
        has led the development of scalable frontend architecture using{' '}
        ...
        BaylinMedia (USA), Phandroid (USA), and IIT Roorkee. I managed multiple
        freelance and agency projects end-to-end, handling both frontend and
        backend responsibilities. I founded{' '}
        <Link
          href="https://stacknothing.com"
          target="_blank"
          rel="noopener noreferrer"
        ...
        <strong className="text-secondary">WordPress</strong>. During this time,
        I launched and managed multiple media platforms including FossNoobs
        Media and HackingSaga Media, and built long-term partnerships with
        brands such as ExpressVPN, NordVPN, AtlasVPS, Surfshark, and others.
      </motion.p>
    </div>
  );
}
