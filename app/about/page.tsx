      ...
      <div className="bg-background">
        <div className="py-12 text-black selection:bg-primary selection:text-secondary px-6 md:px-12 xl:px-16 2xl:px-24">
          ...
          >
            ...
            <strong className="font-bold text-primary">Vite</strong> and
            bundlers like{' '}
            <strong className="font-bold text-primary">Webpack</strong>. I write
            clean, maintainable code following{' '}
            <strong className="font-bold text-primary">
            ...
            <strong className="font-bold text-primary">Framer Motion</strong>{' '}
            for building polished UIs with delightful user experiences. I also
            leverage{' '}
            <strong className="font-bold text-primary">React Query</strong>,{' '}
            <strong className="font-bold text-primary">Zustand</strong>, and{' '}
            <strong className="font-bold text-primary">Firebase</strong> for
